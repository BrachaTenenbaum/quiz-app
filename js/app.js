 ...
 var quiz = {
 	question: [{
 		...
 		correctAnswer: "The Bitterroot Salish, Kootenai, and Pend d'Oreilles Tribes"
 		...
 		correctAnswer: "The Flathead Reservation, over 1.25 million acres of land, was set aside for the tribes exclusive use and benefit including the right to hunt, fish, gather plants, and pasture livestock."
 		...
 		answer: ["The Salish were to pay the US government $55,000 in exchange for new log houses, a side of beef for every family, and plots of land designated specifically for the Salish.", 
  		...
  		correctAnswer: "The Salish were to move from the Bitterroot Valley to the Jocko Reservation (Flathead Reservation) in exchange for $55,000, new log houses, a side of beef for every family, and plots of land designated specifically for the Salish.", 
 		...
 		correctAnswer: "The Flathead Allotment act divided the entire Flathead reservation evenly among Tribal members, giving couples approximatley 160,000 acres of land and singles 80,000 acres of land each."
 		...
 		answer: ["A lot of land is still legaly owned by whites.",
  		...
  		correctAnswer: "A lot of land is still legaly owned by whites."
 ...
 function updateQuestion(questionNumber) {
 	...
 	$('.question1 button:nth-of-type(4)').text(question.answer[3]);
 	$('.question1 button:nth-of-type(5)').text(question.answer[4]);
 	$('.question1 button:nth-of-type(6)').text(question.answer[5]);
...
function displayQuestion() {
  ...
  $('a.btn blue, a.btn green').show(currentQuestion);
  correctAnswer.click()
  updateQuestion ++;
...
//Click game, fist question appears
 $('a.btn blue').show(currentQuestion);
